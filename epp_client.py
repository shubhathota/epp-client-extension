...
class EPPConnection:
    ...
    def contact_create(self, contact_id, voice=None, fax=None, email=None, contacts=[], auth_info=None,extensions=None, **kwargs):
        ...
        return self.call(cmd=commands.contact.create % dict(
            ...
            auth_info='' if not auth_info else commands.contact.auth_info % auth_info,
            contact_type_extension='' if not extensions else commands.contact.contact_type_extension
        ), **kwargs)
